...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiError> handleValidation(
    ...
    return response(HttpStatus.BAD_REQUEST, ApiMessages.VALIDATION_FAILED, request, fieldErrors);
  }
  ...
  public ResponseEntity<ApiError> handleUnexpected(
      Exception exception, HttpServletRequest request) {
    LOGGER.error(
        "Unhandled application error: requestId={}, method={}, path={}",
        request.getAttribute(RequestId.ATTRIBUTE_NAME),
        request.getMethod(),
        request.getRequestURI(),
        exception);
    return response(
        HttpStatus.INTERNAL_SERVER_ERROR, ApiMessages.INTERNAL_ERROR, request, Map.of());
  }
  ...
  private void logExpectedFailure(
      HttpStatus status, HttpServletRequest request, String exceptionType) {
    LOGGER.warn(
