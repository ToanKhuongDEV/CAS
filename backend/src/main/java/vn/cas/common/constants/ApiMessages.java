...
public final class ApiMessages {
  ...
  public static final String LONG_WAIT_WARNING_SETTING_RETRIEVED =
      "Đã lấy cấu hình cảnh báo bàn chờ lâu.";
  public static final String LONG_WAIT_WARNING_SETTING_UPDATED =
      "Đã cập nhật cấu hình cảnh báo bàn chờ lâu.";
  ...
  public static final String OPERATOR_EMAIL_ALREADY_EXISTS =
      "Email này đã được đăng ký cho tài khoản nhân viên.";
  public static final String FIREBASE_UID_ALREADY_EXISTS =
      "Tài khoản Firebase này đã được đăng ký.";
  ...
  public static final String INVALID_TABLE_QR_CODE =
      "Mã QR của bàn không hợp lệ hoặc đã ngừng hoạt động.";
  public static final String CUSTOMER_TABLE_SESSION_REQUIRED =
      "Vui lòng quét mã QR của bàn để tiếp tục.";
  public static final String CATALOG_RESOURCE_NOT_FOUND = "Không tìm thấy dữ liệu thực đơn.";
  public static final String CATALOG_RESOURCE_IN_USE =
      "Dữ liệu thực đơn đang được sử dụng nên không thể xóa.";
  ...
  public static final String FIREBASE_CREDENTIALS_UNAVAILABLE =
      "Dịch vụ xác thực hiện chưa sẵn sàng.";
  public static final String FIREBASE_AUTH_UNAVAILABLE =
      "Không thể kết nối dịch vụ xác thực. Vui lòng thử lại sau.";
  public static final String OPERATIONAL_ACCOUNT_UNAVAILABLE =
