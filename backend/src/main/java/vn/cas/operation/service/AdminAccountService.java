...
public class AdminAccountService {
  ...
  public AdminAccountService(
      OperationalAccountMapper accountMapper, AuditLogService auditLogService) {
  ...
  public AdminAccount create(
    ...
    var command =
        new CreateAdminAccountCommand(principal.storeId(), firebaseUid, email, phone, displayName);
    try {
