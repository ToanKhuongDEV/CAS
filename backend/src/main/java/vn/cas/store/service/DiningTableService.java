...
public class DiningTableService {
  ...
  public DiningTable create(
      OperationalPrincipal principal, long code, Integer capacity, UUID requestId) {
    ...
    var command =
        new CreateDiningTableCommand(principal.storeId(), code, capacity, principal.accountId());
    try {
    ...
    diningTableMapper.insertActiveQrCode(
        command.getId(), qrToken, LocalDateTime.now(BUSINESS_ZONE));
