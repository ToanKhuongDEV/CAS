...
class CustomerTableSessionServiceTest {
    ...
    private final CustomerTableSessionService service = new CustomerTableSessionService(diningTableMapper);
    ...
    void shouldRequireCustomerInformationWhenTableHasNoOpenSession() {
        ...
        var result = service.resolveQr(new CustomerTableSessionResolutionCommand("a".repeat(64), null, null));
    ...
    void shouldCreateOpenSessionForFirstCustomer() {
        ...
        var result = service.resolveQr(new CustomerTableSessionResolutionCommand(
