...
import vn.cas.store.infrastructure.persistence.mybatis.StoreSettingsMapper;
...
class LongWaitWarningSettingServiceTest {
    ...
    void shouldUpdateSettingAndRecordAuditLog() {
        ...
        ArgumentCaptor<AuditLogCommand> auditCommandCaptor = ArgumentCaptor.forClass(AuditLogCommand.class);
