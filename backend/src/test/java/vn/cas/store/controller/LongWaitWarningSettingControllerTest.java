...
class LongWaitWarningSettingControllerTest {
  ...
  private final LongWaitWarningSettingService settingService =
      mock(LongWaitWarningSettingService.class);
  private final LongWaitWarningSettingController controller =
      new LongWaitWarningSettingController(settingService);
  private final OperationalPrincipal principal =
      new OperationalPrincipal(7L, 2L, "firebase-user-1", "Admin One", "ADMIN");
