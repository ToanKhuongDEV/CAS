        ...
        <main className="min-w-0 flex-1">
          <section className="text-center" aria-labelledby="order-success-title">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-cas-on-surface-variant">
              Đơn hàng <strong className="text-cas-on-surface">#CAS-123</strong> đã được gửi thành
              công. Bạn có thể tiếp tục gọi thêm món trong bữa ăn.
            </p>
          </section>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center md:gap-4">
            <CasButton
              ...
              icon="payment"
              href="/payment"
              className="min-h-12 sm:min-w-[15rem]"
            >
              Yêu cầu thanh toán
            </CasButton>
            <CasButton
              ...
              icon="plus"
              href="/menu"
              className="min-h-13 shadow-[0_8px_20px_var(--cas-shadow-color)] sm:min-w-[15rem]"
            >
              Gọi thêm món
            </CasButton>
          </div>
