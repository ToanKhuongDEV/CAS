    ...
    <div className="min-h-screen bg-cas-surface text-cas-on-surface transition-colors duration-200">
      ...
      <div className="mx-auto flex w-full max-w-[85rem] items-start gap-8 px-4 pt-20 pb-28 md:gap-12 md:px-8 md:pt-24 md:pb-16 lg:gap-14">
        ...
        <main className="min-w-0 flex-1">
          ...
          <h1
            className="mx-auto mt-2 max-w-lg text-2xl leading-tight font-extrabold tracking-tight md:text-3xl"
        ...
        <article className="mt-6 rounded-2xl bg-cas-surface-container p-5 shadow-[0_5px_18px_var(--cas-shadow-color)] md:rounded-3xl md:p-7">
          <div className="flex items-center justify-between gap-4 border-b border-cas-outline-variant/40 pb-4">
            ...
            <span className="rounded-full bg-cas-secondary-container/20 px-3.5 py-1 text-xs font-extrabold text-cas-secondary md:text-sm">
              4 món
            </span>
          </div>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center md:gap-4">
          <Link
            className="flex min-h-12 items-center justify-center gap-2 rounded-xl border border-cas-primary/30 bg-cas-surface-container px-6 font-extrabold text-cas-primary transition hover:bg-cas-primary/8 focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-cas-focus-ring sm:min-w-[15rem]"
            href="/payment"
          >
          ...
          <Link
            className="flex min-h-13 items-center justify-center gap-2 rounded-xl bg-cas-primary px-6 font-extrabold text-cas-on-primary shadow-[0_8px_20px_var(--cas-shadow-color)] transition hover:bg-cas-primary-hover focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-cas-focus-ring sm:min-w-[15rem]"
            href="/menu"
          >
