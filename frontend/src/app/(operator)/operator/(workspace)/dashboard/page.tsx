            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-cas-on-surface-variant">
                  Thời gian được tính từ lúc bàn bắt đầu chờ món chưa hoàn
                  thành. Ngưỡng cảnh báo hiện tại:{" "}
                ...
                {table.tone === "active" ? (
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-[0.68rem] font-bold text-cas-secondary">
                        {table.status}
                      </p>
                    </div>
                  </Link>
                  ...
                  <div>
                    <p className="font-extrabold">{table.label}</p>
                      <p className="mt-1 text-[0.68rem] font-bold text-cas-on-surface-variant">
                        {table.status}
                      </p>
                  </div>
                  </div>
